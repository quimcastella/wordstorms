...
class EngineWord {
	...
	EngineWord(Word word, int rank, int wordCount, BBTreeBuilder bbTreeBuilder, PVector desLoc, PVector curLoc) {
		this.word = word;
		this.rank = rank;
		this.bbTreeBuilder = bbTreeBuilder;
	...
	void setLocations(PVector curLoc, PVector desLoc){
